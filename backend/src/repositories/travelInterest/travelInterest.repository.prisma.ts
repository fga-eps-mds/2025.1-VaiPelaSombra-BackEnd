...
import { ITravelInterestRepository } from '../travelInterest/travelInterest.repository';

export class PrismaTravelInterestRepository implements ITravelInterestRepository {
