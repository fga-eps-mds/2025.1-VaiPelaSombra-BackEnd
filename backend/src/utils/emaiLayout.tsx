      ...
      <Body style={main}>
        <Container style={container}>
          <Section style={section}>
            <Text style={text}>
              Recebemos uma solicitação redefinir a sua senha. Clique no botão abaixo para prosseguir e redefinir sua senha.
              Para isso acessa a sua conta usando essa senha temporaria: {novaSenha}
            </Text>
